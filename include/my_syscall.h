...
static syscall_t table[330] = {{0, "read", 3, NUM, NUM, VOID_P, NUM, 0, 0, 0},
    ...
    {12, "brk", 1, PVOID, VOID_P, 0, 0, 0, 0, 0},
    ...
    {38, "setitimer", 3, NUM, NUM, CONST_STRUCT_ITIMERVAL_P,
        STRUCT_ITIMERVAL_P, 0, 0, 0}, {39, "getpid", 1, NUM,
        VOID, 0, 0, 0, 0, 0},
    ...
    {59, "execve", 3, NUM, STRING, STRING, VOID_P, 0, 0, 0},
    ...
    {262, "newfstatat", 6, NUM, NUM, STRING, 0, 0, 0, 0},
